...
Open [the static gallery](gallery/index.html), then read [manifest.json](manifest.json) and [qa_report.md](qa_report.md). The raw centre-plane extract and merged force history are in `data/`. The force figure is provided as PNG, SVG, and PDF. Preview and final field figures are separate.
